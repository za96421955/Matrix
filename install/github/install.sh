...
LATEST_VERSION_URL="https://raw.githubusercontent.com/za96421955/Matrix/latest/install/github/latest-version.txt"
...
get_latest_version_info() {
    ...
    if [ -f "$url_file" ]; then
        ...
        version_url="https://raw.githubusercontent.com/za96421955/Matrix/latest/install/github/latest-version.txt"
    fi
    local tmpfile
    tmpfile=$(mktemp)
