                                    ...
                                    >
                                        ...
                                        {formattedArgs && formattedArgs !== '{}' && (
                                            <div className="mb-2.5">
                                                <span className="text-[10px] font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1 block">参数</span>
                                                <pre className="text-xs bg-gray-50/70 dark:bg-[#252529]/40 rounded-lg p-2.5 overflow-x-auto font-mono text-gray-700 dark:text-gray-300 leading-relaxed border border-gray-100/40 dark:border-white/[0.06]/20">
                                                    {formattedArgs}
                                                </pre>
                                            </div>
                                        )}
                                        ...
                                        {/* 结果 */}
                                        <div>
                                            <span className="text-[10px] font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1 block">结果</span>
                                            {resultContent ? (
                                                isQRCode ? (
                                                    <pre className="qrcode overflow-x-auto text-xs text-gray-700 dark:text-gray-300">
        ...
        <div className="mb-1.5">
            ...
            {open && (
                <motion.div
                    initial={{ height: 0, opacity: 0 }}
                    animate={{ height: 'auto', opacity: 1 }}
                    className="mt-1 p-2 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-white/[0.06] text-xs text-gray-500 dark:text-gray-400 leading-relaxed whitespace-pre-wrap overflow-auto max-h-40 break-words"
                >
                    {content}
                </motion.div>
            )}
            ...
            <div className="absolute -top-2.5 right-0 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all z-10">
                {showCopy && onCopy && (
                    <button
                        ...
                        className="rounded-full p-1.5 bg-white dark:bg-gray-800 shadow-md border border-gray-200 dark:border-white/[0.06] hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-all"
                    >
                ...
                {showConfirm && (
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">确定要删除该消息吗？此操作不可撤销。</p>
                            <div className="flex justify-end gap-3">
                                <button
                                    onClick={handleCancel}
                                    className="px-4 py-2 text-sm font-medium rounded-lg border border-gray-200 dark:border-white/[0.06] text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                                >
                                    取消
                                </button>
                                <button
            ...
            <motion.div initial={{opacity: 0, y: 8}} animate={{opacity: 1, y: 0}}
                ...
                <div
                    ...
                    <div className="flex items-center gap-1.5 mb-1">
                        ...
                        <span className="text-xs text-gray-400 dark:text-gray-500 font-medium">系统提示</span>
                    </div>
                    <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed break-words">{message.content}</p>
                </div>
            </motion.div>
        )
    }
                        ...
                        if (hasReasoning && !hasContent) {
                            return (
                                <div
                                    ...
                                    <div
                                        className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed whitespace-pre-wrap break-words">
                            ...
                            <>
                                ...
                                {hasContent && (
                                    <div className="relative">
                                        <div
                                            className={
                                                'rounded-2xl px-4 py-3 shadow-sm max-w-full relative bg-gray-100 dark:bg-[#1c1c20]/80 text-gray-900 dark:text-gray-100 rounded-tl-sm' +
